...
def actions(board):
    ...
    """
    #Give the board input and output.
    if terminal(board):
        return None
    possible_actions = []
    for i in range(3):
...
def minimax(board):
    ...
    for action in actions(board):
        ...
        #Label an auxiliary function to help keep track of the values as they progress through the search tree.
...
def minimax_aux(board, value):
    ...
    #Whenever the board is full, and the recursion's state is on a leaf.
    if terminal(board):
